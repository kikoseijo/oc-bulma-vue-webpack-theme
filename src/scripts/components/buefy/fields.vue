<template>
<div class="ks-fields container">
  <!-- https://raw.githubusercontent.com/rafaelpimpa/buefy/8e22beb9843e8e284b6635659ae9c4a801f7024a/docs/pages/documentation/general/Tabs.vue -->
  ...
  <p class="content">
    Nested Fields can be grouped as well, you have to use the <code>expanded</code> prop <u>on the Field</u> to <b>fill up the remaining space</b>.
  </p>
  <div class="example">
    <b-field grouped>
  ...
  <p class="content">
    Add the <code>group-multiline</code> prop to allow controls to fill up <b>multiple lines</b>. This is ideal for a long list of controls.
  </p>
  <div class="columns">
    <div class="column">
